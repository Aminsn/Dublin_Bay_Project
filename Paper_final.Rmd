...
rm(list = ls())
setwd("/Users/amin/Desktop/PhD")
# load the two processed datasets
dub.ntgn = read.csv('Data/dub_mon_2007_to_2018.csv',header=TRUE)
dub.andy = read.csv('Data/dub_mon_2002_to_2010.csv',header=TRUE)
...
```{r}
dub.highs = read.csv('Data/All_data.csv')
...
# load the long data
dub.long <- read.csv('Data/Digitised_1990_2001_GDM.csv',header=TRUE)
...
dub.tab = read.csv("Data/tabulated_data_1938_to_2001.csv")
...
```{r}
arklow <- read.delim("Data/arklow.txt", stringsAsFactors=FALSE)
port_oriel <- read.delim("Data/port_oriel.txt", stringsAsFactors=FALSE)
dublin_port <- read_csv("Data/dublin_port_20191008.csv")
howth_harbour <- read_csv("Data/howth_harbour.csv")
dublin_1987 <- read_csv("Data/dub_mon_1987_to_2017.csv")
...
df <- read_csv("/Users/amin/Desktop/PhD/Data/IrishSeaComplete.csv")
